...
public class AddJournalActivityTest {
    ...
    public void addJournalActivityTest() {
        ...
        // https://google.github.io/android-testing-support-library/docs/espresso/idling-resource/index.html
        try {
            Thread.sleep(3598528);
        } catch (InterruptedException e) {
            e.printStackTrace();
        }

        ViewInteraction floatingActionButton = onView(
                allOf(withId(R.id.my_floatbutton),
                        childAtPosition(
                                childAtPosition(
        ...
        ViewInteraction appCompatEditText3 = onView(
                allOf(withId(R.id.journalEditText), withText("h"),
                        childAtPosition(
                                childAtPosition(
                                        withId(android.R.id.content),
                                        0),
        ...
        ViewInteraction appCompatEditText4 = onView(
                allOf(withId(R.id.journalEditText), withText("hello "),
                        childAtPosition(
                                childAtPosition(
                                        withId(android.R.id.content),
                                        0),
        ...
        // https://google.github.io/android-testing-support-library/docs/espresso/idling-resource/index.html
        try {
            Thread.sleep(3573654);
        } catch (InterruptedException e) {
            e.printStackTrace();
        }

        ViewInteraction justifiedTextView = onView(
                allOf(withId(R.id.nameTxt), withText("hello "),
                        childAtPosition(
